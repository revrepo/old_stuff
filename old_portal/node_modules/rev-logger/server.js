...
var transport = new winston.transports.Syslog({
  ...
  level: conf.logging.logging.syslog_level,
  id: 'hello syslog',
  facility: 'user',
  prettyPrint: true,
  colorize: true,
...
var delogger = new(winston.Logger)({
  transports: [
    new(winston.transports.File)({
      filename: conf.logging.logging.debug_log_file_path,
      level: 'debug',
      colorize: true,
      facility: 'user',
      json: false,
...
exports.audit = function (msg) {

  // Write to local log file
  delogger.log('info', msg);

  // Write to syslog
  logger.log('info', msg);

  // TODO: Add audit logging to the database
};
