 ...
 */
public abstract class RmpHeaders implements Iterable<Map.Entry<String, String>> {
    ...
    public static final RmpHeaders EMPTY_HEADERS = new RmpHeaders() {
        @Override
        ...
        @Override
        public RmpHeaders add(String name, Object value) {
            throw new UnsupportedOperationException("read only");
        }

        @Override
        public RmpHeaders add(String name, Iterable<?> values) {
            throw new UnsupportedOperationException("read only");
        }

        @Override
        public RmpHeaders set(String name, Object value) {
            throw new UnsupportedOperationException("read only");
        }

        @Override
        public RmpHeaders set(String name, Iterable<?> values) {
            throw new UnsupportedOperationException("read only");
        }

        @Override
        public RmpHeaders remove(String name) {
            throw new UnsupportedOperationException("read only");
        }

        @Override
        public RmpHeaders clear() {
            throw new UnsupportedOperationException("read only");
        }
    ...
    /**
     * Create a new {@link CharSequence} which is optimized for reuse as {@link RmpHeaders} name or value.
     ...
     */
    public abstract RmpHeaders add(String name, Object value);
     ...
     * @return {@code this}
     */
    public RmpHeaders add(CharSequence name, Object value) {
     ...
     */
    public abstract RmpHeaders add(String name, Iterable<?> values);
     ...
     * @return {@code this}
     */
    public RmpHeaders add(CharSequence name, Iterable<?> values) {
     ...
     * @return {@code this}
     */
    public RmpHeaders add(RmpHeaders headers) {
        if (headers == null) {
     ...
     */
    public abstract RmpHeaders set(String name, Object value);
     ...
     * @return {@code this}
     */
    public RmpHeaders set(CharSequence name, Object value) {
     ...
     */
    public abstract RmpHeaders set(String name, Iterable<?> values);
     ...
     * @return {@code this}
     */
    public RmpHeaders set(CharSequence name, Iterable<?> values) {
     ...
     * @return {@code this}
     */
    public RmpHeaders set(RmpHeaders headers) {
        if (headers == null) {
            throw new NullPointerException("headers");
        }
     ...
     */
    public abstract RmpHeaders remove(String name);
     ...
     * @return {@code this}
     */
    public RmpHeaders remove(CharSequence name) {
     ...
     * @return {@code this}
     */
    public abstract RmpHeaders clear();
